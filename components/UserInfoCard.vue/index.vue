<template>
    <div class="userInfoCard m-1 rounded-lg hover:bg-base-300 transition-all collapse collapse-arrow" tabindex="0">
        ...
        <div class="collapse-content">
            <div class=" text-sm">
                <div class="flex">
                    <b>ID: </b>
                    <a @click="copy(UserInfoManager.id.value)" class="link link-hover overflow-hidden ms-2 me-2 text-neutral-400 text-sm flex-1">复制</a>
                    <b>RSA key: </b>
                    <a @click="copy(UserInfoManager.public_rsa_key)" class="link link-hover overflow-hidden ms-2 me-2 text-neutral-400 text-sm flex-1">复制</a>
